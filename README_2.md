...
Traditional interpretability assumes a single "correct" view of neural computations. We show this is fundamentally incomplete - like trying to understand relativity from a single reference frame.
